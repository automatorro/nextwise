  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-foreground">Analiza Progresului</h2>
          <p className="text-muted-foreground">Urmărește-ți evoluția în timp</p>
        </div>
                  ...
                  {achievements.map((achievement, index) => (
                    ...
                    >
                      ...
                      <div className="text-xs text-muted-foreground">
                        {achievement.steps_completed} pași • {achievement.milestones_reached} jaloane
                      </div>
                    </div>
                  ))}
                </div>
