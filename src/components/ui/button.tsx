...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, onClick, onTouchStart, onTouchEnd, ...props }, ref) => {
    ...
    const handleTouchStart = (e: React.TouchEvent<HTMLButtonElement>) => {
      console.log('Button: Touch start event triggered');
      if (onTouchStart) {
        onTouchStart(e);
      }
    };
    ...
    const handleTouchEnd = (e: React.TouchEvent<HTMLButtonElement>) => {
      console.log('Button: Touch end event triggered');
      if (onTouchEnd) {
        onTouchEnd(e);
      }
    };
