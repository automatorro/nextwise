...
export const calculateEnneagramScore = (answers: Record<string, number>): EnneagramScore => {
  ...
  const questionTypeMap: Record<string, keyof EnneagramScore> = {
    // Type 1 - Reformatorul (întrebările 1-4)
    ...
    // Type 2 - Ajutătorul (întrebările 5-8)
    ...
    // Type 3 - Realizatorul (întrebările 9-12)
    ...
    // Type 4 - Individualistul (întrebările 13-16)
    ...
    // Type 5 - Investigatorul (întrebările 17-20)
    ...
    // Type 6 - Loyalul (întrebările 21-24)
    ...
    // Type 7 - Entuziastul (întrebările 25-28)
    ...
    // Type 8 - Provocatorul (întrebările 29-32)
    ...
    // Type 9 - Mediatorul (întrebările 33-36)
    'eec24244-725f-434f-8c14-1986bbd31a3c': 'type9',
